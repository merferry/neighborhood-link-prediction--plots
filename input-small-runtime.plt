...
set output 'input-small-runtime.pdf'
...
plot "input-small.csv" \
  ...
  '' using ($0-5.2/20):($6 /1000):(sprintf("%.1f", $6 /1000))      with labels textcolor rgb 'white' rotate by 90 offset character 0,-1 title '', \
  ...
  '' using ($0-1.8/20):($7 /1000):(sprintf("%.1f", $7 /1000))      with labels textcolor rgb 'white' rotate by 90 offset character 0,-1 title '', \
  ...
  '' using ($0+1.8/20):($8 /1000):(sprintf("%.1f", $8 /1000))      with labels textcolor rgb 'white' rotate by 90 offset character 0,-1 title '', \
  ...
  '' using ($0+5.2/20):($9 /1000):(sprintf("%.1f", $9 /1000))      with labels textcolor rgb 'white' rotate by 90 offset character 0,-1 title '', \
